...
function insertShame() {
	...
	page.insertAdjacentHTML('afterbegin', '<div id="shame-message"><h1>You don\'t want to do this.</h1><h2>Think of all the productive things you could be doing instead of being on Discord.</h2><button id="quit">You\'re right. Close Discord so I can do something productive.</button><div id="continue">I\'ve been working really hard, so I\'m going to use Discord.</div></div>');
}
